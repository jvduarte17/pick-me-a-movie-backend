...
var MovieRepositoryMemory_1 = require("./infra/repository/memory/MovieRepositoryMemory");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                movieRepo = new MovieRepositoryMemory_1["default"]();
                useCase = new CreateMovie_1["default"](movieRepo);
                console.log('teste');
                return [4 /*yield*/, useCase.create(movie)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
